...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:gaureshkapoor@gmail.com)
...
- **[Vault](https://joinvault.app)** — agentic AI platform for ideation, task-planning & execution. *Available now!*
...
![LLMs](https://img.shields.io/badge/LLMs_&_Agents-000000?style=flat-square)
...
```text
think  →  ChatGPT · Claude
scaffold →  Lovable → Cursor → Warp → GitHub → Claude Code / Codex → CodeRabbit
build  →  Next.js · TypeScript · Tailwind · Expo · Swift
power  →  Supabase · Openrouter · Vercel
run    →  Stripe · PostHog · Sentry · Mailchimp
```

## 🎯 Outside the Terminal

🌍 Travel · 🏔️ Adventure sports · ⚽ Soccer · 🎤 Stand-up · 🎮 Video games · 🎶 Bollywood · 🏋️ Gym
</div>
